...
| Name       | Description                                                 |
| ---------- | ----------------------------------------------------------- |
| `backends` | Deprecated. Import directly from mkdocs_spellcheck instead. |
| `plugin`   | Deprecated. Import directly from mkdocs_spellcheck instead. |
| `words`    | Deprecated. Import directly from mkdocs_spellcheck instead. |
...
| `CodespellBackend`  | Backend for the codespell tool.       |
| `SpellCheckPlugin`  | A mkdocs plugin.                      |
| `SymspellpyBackend` | Backend for the symspellpy library.   |
...
| ------------- | ---------------- | ----------------------------------- | --------------------- |
| `config`      | `dict[str, Any]` | User configuration from mkdocs.yml. | *required*            |
| `known_words` | \`set[str]       | None\`                              | Globally known words. |
...
| Name    | Description                                      |
| ------- | ------------------------------------------------ |
| `check` | Check a word against the codespell misspellings. |
...
| Name    | Description                                     |
| ------- | ----------------------------------------------- |
| `check` | Check a word against the symspellpy dictionary. |

Attributes:

| Name    | Type | Description                   |
| ------- | ---- | ----------------------------- |
| `spell` |      | The symspellpy spell checker. |
...
| --------------- | ---------- | ---------------------------------- | ----------------- |
| `html`          | `str`      | The HTML text.                     | *required*        |
| `known_words`   | \`set[str] | None\`                             | Words to exclude. |
...
| Name         | Description                                                 |
| ------------ | ----------------------------------------------------------- |
| `codespell`  | Deprecated. Import directly from mkdocs_spellcheck instead. |
| `symspellpy` | Deprecated. Import directly from mkdocs_spellcheck instead. |
